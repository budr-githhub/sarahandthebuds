...
Released in PR #5 (`b99f8f1`). Bud approved selection and publication.

- Hero: `sarah-and-the-buds-band-only-hero.webp`, AI-edited from photo 4 (barn portrait), dark background.
- Band introduction: photo 10, `sarah-and-the-buds-georgetown-underground-portrait.webp`.
- Duo introduction: `sarah-and-bud-portrait-with-guitar-and-microphone.webp`.
- Both introduction frames are 4:5. Photo 11 is excluded.
- Gallery: six original Facebook photos, former Georgetown hero, duo performance, full-band performance, original barn portrait, outdoor crowd selfie and storefront/show-sign photo: 12 total.
